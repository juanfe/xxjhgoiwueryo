...
scenario = {'test_init' : '../mo.csv', 
		...
		'test_addLoans' : { 'p' : ['Loan Id', 'MO', 'Loan Amount', 'Rate'],
			...
			'r' : [{'Loan Id': '1', 'MO': 'ABC Mortgage', 'Loan Amount': 318725.0, 'Rate': 0.01}],
			},
		'test_LoadLoans' : 
				[{'Loan Id': '1', 'MO': 'ABC Mortgage', 'Loan Amount': 318725.0, 'Rate': 0.01},
				{'Loan Id': '2', 'MO': 'ABC Mortgage', 'Loan Amount': 375685.0, 'Rate': 0.01},
				{'Loan Id': '3', 'MO': 'Prime Lending', 'Loan Amount': 479875.0, 'Rate': 0.01},
				{'Loan Id': '4', 'MO': 'Prime Lending', 'Loan Amount': 525400.0, 'Rate': 0.01},
				{'Loan Id': '5', 'MO': 'Best Loans Inc', 'Loan Amount': 515425.0, 'Rate': 0.01},
				{'Loan Id': '6', 'MO': 'Integrity Lending', 'Loan Amount': 485000.0, 'Rate': 0.01},
