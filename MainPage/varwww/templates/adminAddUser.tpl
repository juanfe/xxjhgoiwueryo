...
<body>
	...
	<div id="title">
		<div id="wrapbig">
			<div class="titlebox">
				<h2>General Administrator Panel - Add User to Company: {$company}</h2>
			</div>
		</div>
	</div>
	...
	{if $admin eq 1}
	<div id="container">
	<form id="form3" action="addUser2.php?company={$company}" method="post">
			<fieldset><legend>Sign up form</legend>
				...
				<p>
					<input type="checkbox" name="userAdmin" value="YES">Company Admin?
				</p>
			</fieldset>
