...
<body>
	...
	<div id="title">
		<div id="wrap">
			<div class="titlebox">
				<h2>Company Administrator Panel</h2>
			</div>
		</div>
	</div>
	...
	<div id="container">
		...
		<tr>
			...
			<table id="table-3">
				<tr><td align="center"><br><span style="cursor: pointer;"><a href="companyAdminFeatures/compUsersList.php" class="button">Users List</a></span><br><br></td></tr>
			</table>
		</tr>
		<tr>
			<br><br><h3>Modification Pane</h3><br>
			<table id="table-3">
				<tr>
				<td align="center"><br><span style="cursor: pointer;"><a href="companyAdminFeatures/addUser.php" class="button">Add User to Your Company</a></span><br><br></td>
				<td align="center"><br><span style="cursor: pointer;"><a href="companyAdminFeatures/selectUser.php" class="button2">Modify User</a></span></td>
				<td align="center"><br><span style="cursor: pointer;"><a href="companyAdminFeatures/selectDeleteUser.php" class="button2">Delete user</a></span></td>
				</tr>
			</table>
		</tr>
		</table>
