...
<body>
	...
	<div id="title">
		<div id="wrap">
			<div class="titlebox">
				<h2>General Administrator Panel - Add User to Company Result</h2>
			</div>
		</div>
	</div>
	...
	{if $admin eq 1}
		<div id="container">
			{if $adminuAddSuccess eq 1}
			<form id="form1" action="../index.php" method="post">
				<fieldset><legend></legend>
					<p class="first">
						<label for="goHome">The new user was successfully created. In order to completely activate this user, please login and access the sweet SPOT system.</label>
					</p>
				</fieldset>
				<p class="submit"><button type="submit">go Home</button></p>
			</form>
			{else}
			<form id="form1" action="../companyAdminPanel.php" method="post">
                                <fieldset><legend></legend>
                                        <p class="first">
                                                <label for="goHome">An error ocurred while creating the new user. Please try again.</label>
                                        </p>
                                </fieldset>
                                <p class="submit"><button type="submit">go to Admin Panel</button></p>
                        </form>			
			{/if}
		</div>
	{else}
