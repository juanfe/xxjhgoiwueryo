...
<body>
	...
	<div id="title">
                <div id="wrapbig">
                        <div class="titlebox">
                                <h2>General Administrator Panel - Company Users List</h2>
                        </div>
                </div>
        </div>
	...
	{if $admin eq 1}
	<div id="container">
	Select the Company you want to see the registered users
	<form id="form2" action="usersInCompany.php" method="post">
