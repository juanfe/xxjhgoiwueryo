...
<body>
	...
	<div id="title">
		<div id="wrap">
			<div class="titlebox">
				<h2>General Administrator Panel</h2>
			</div>
		</div>
	</div>
	...
	<div id="container">
		...
		<tr>
			...
			<table id="table-3">
				<tr>
				<td align="center"><br><span style="cursor: pointer;"><a href="adminFeatures/companiesList.php" class="button">Companies List</a></span><br><br></td>
				<td align="center"><br><span style="cursor: pointer;"><a href="adminFeatures/selectUsersInCompany.php" class="button">Users in a Company</a></span><br><br></td>
				</tr>
			</table>
		</tr>
		<tr>
			<br><br><h3>Modifications Pane</h3><br>
			<table id="table-3">
				<tr>
				<td align="center"><br><span style="cursor: pointer;"><a href="adminFeatures/addCompany.php" class="button">Add Company</a></span><br><br></td>
				<td align="center"><br><span style="cursor: pointer;"><a href="adminFeatures/selectCompany.php" class="button2">Modify Company</a></span></td>
				<td align="center"><br><span style="cursor: pointer;"><a href="adminFeatures/selectDeleteCompany.php" class="button2">Delete Company</a></span></td>
				</tr>
				<tr>
				<td align="center"><br><span style="cursor: pointer;"><a href="adminFeatures/adminAddUserSelect.php" class="button">Add User</a></span><br><br></td>
				<td align="center"><br><span style="cursor: pointer;"><a href="adminFeatures/adminModUserSelect.php" class="button2">Modify User</a></span><br><br></td>
				<td align="center"><br><span style="cursor: pointer;"><a href="adminFeatures/adminDelUserSelect.php" class="button2">Delete User</a></span></td>
				</tr>
			</table>
		</tr>
		</table>
