		...
		<div id="container">
			...
			<form id="form1" action="../index.php" method="post">
				<fieldset><legend></legend>
					<p class="first">
						<label for="goHome">The new company was successfully created.</label>
					</p>
				</fieldset>
				<p class="submit"><button type="submit">go Home</button></p>
			</form>
			{else}
			<form id="form1" action="../adminPanel.php" method="post">
                                <fieldset><legend></legend>
                                        <p class="first">
                                                <label for="goHome">An error ocurred while creating the new company. Please try again.</label>
                                        </p>
                                </fieldset>
