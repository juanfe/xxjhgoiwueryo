...
<body>
	<div id="header">
		...
		<ul id="menu">
			...
			<li class="active"><a href="what.php">{#what#}</a></li>
	...
	<div class="wrap2">
	<h1>EVERY ADVANCE IS UNIQUE - AND CUSTOMIZED</h1><br><br><br>
	<table border="0" width="740" style="table-layout:fixed">
	<td width="500">
	<h6>Using our Sweet SPOT technology, our platform enables the commodity (warehouse financing) to be customized - to the mortgage originator and to the supply side investor on a loan level basis.</h6><br><br>
	<img src="images/starbucks.png"><br><br>
	<h6>The ability to customize without upfront costs as in the traditional market is what provides the value proposition to the stakeholders.</h6>
	</td>
	<td>
	<img src="images/what1.png"><br><br><h3>Unique Investor Bias</h3>
	</td>
	</table>
	</div>
